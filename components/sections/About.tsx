        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
          ...
          <motion.div variants={fadeUp} custom={0.18} initial="hidden" whileInView="visible"
            ...
            <p style={{ color: 'rgba(228,228,231,0.5)', fontSize: '0.92rem', lineHeight: 1.85, margin: 0,
              ...
              I&apos;m a self-taught systems architect and solo entrepreneur who builds
              products end-to-end — from database schema to deployment pipeline,
              from user behavior design to business logic architecture. No team.
              No shortcuts. Every layer, intentional.
            </p>
            <p style={{ color: 'rgba(228,228,231,0.5)', fontSize: '0.92rem', lineHeight: 1.85, margin: 0,
              fontFamily: 'var(--font-space-grotesk)' }}>
              My process doesn&apos;t start with frameworks. It starts with questions:
              What problem persists? Who does this system serve? What behavior
              needs to change? Architecture follows those answers — not the other
              way around.
            </p>
            <p style={{ color: 'rgba(228,228,231,0.5)', fontSize: '0.92rem', lineHeight: 1.85, margin: 0,
              fontFamily: 'var(--font-space-grotesk)' }}>
              I&apos;m drawn to the intersection of product engineering and operational
              design — systems that don&apos;t just function, but behave intelligently
              under real-world conditions and compound in value over time.
            </p>
          </motion.div>
